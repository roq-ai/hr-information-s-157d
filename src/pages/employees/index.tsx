            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('benefits', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>benefits</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    <Td>{record.personal_details}</Td>
                    <Td>{record.work_details}</Td>
                    <Td>{record.emergency_contacts}</Td>
                    ...
                    {hasAccess('benefits', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.benefits}</Td>
                    )}
                    {hasAccess('offboarding', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.offboarding}</Td>
                    )}
