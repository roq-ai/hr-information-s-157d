...
import { getOffboardingById } from 'apiSdk/offboardings';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('offboarding', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/offboardings/edit/${data?.id}`} passHref legacyBehavior>
              <Button
                ...
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/employees/view/${data?.employee?.id}`}>
                      {data?.employee?.personal_details}
                    </Link>
                  </Text>
                </Flex>
              )}
