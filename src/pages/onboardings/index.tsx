...
function OnboardingListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('onboarding', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/onboardings/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('onboarding', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/onboardings/create`} passHref legacyBehavior>
