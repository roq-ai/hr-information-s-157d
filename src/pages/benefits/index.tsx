...
import { getBenefits, deleteBenefitsById } from 'apiSdk/benefits';
...
function BenefitsListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('benefits', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/benefits/view/${id}`);
    }
  };
    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('benefits', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
