...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Benefits', path: '/benefits', entity: 'benefits', service: AccessServiceEnum.PROJECT, icon: FiGift },
    ...
    { name: 'Policy', path: '/policies', entity: 'policy', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    {
      name: 'Recruitment',
      path: '/recruitments',
      entity: 'recruitment',
